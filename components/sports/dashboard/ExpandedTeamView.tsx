...
import { teamGradient } from "@/lib/sports/leagues";
  ...
  return (
    ...
    >
      ...
      <div className="animate-modal-pop relative w-full max-w-3xl">
        <div className="rounded-3xl p-[2px]" style={{ background: teamGradient(team) }}>
          <div className="max-h-[85vh] overflow-y-auto rounded-[calc(1.5rem-2px)] bg-[#16171B]">
            {/* Sticky header: card header + tabs */}
            <div className="sticky top-0 z-10 border-b border-white/5 bg-[#16171B]/95 px-5 py-4 backdrop-blur-sm sm:px-7">
